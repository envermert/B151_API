...
public class Get12 extends GoRestBaseUrl {
    ...
    /*
      Given
          https://gorest.co.in/public/v1/users/4503033
      When
      ...
      And
          Response body should be like
        {
          ...
          "data": {
                "id": 4503033,
                "name": "Anang Kakkar",
                "email": "anang_kakkar@armstrong.example",
                "gender": "female",
                "status": "inactive"
          }
      }
  */
    ...
    public void get12() {
        //Set the URL
        spec.pathParams("first", "users", "second", 4503033);

        //Set the expected data
        GoRestDataPojo goRestData = new GoRestDataPojo("Anang Kakkar","anang_kakkar@armstrong.example","female","inactive");
